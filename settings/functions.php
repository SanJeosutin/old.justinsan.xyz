...
<?php
    ...
    function createCard($dataPath ,$path, $imgPath, $projectPath, $githubURL, $desc){
        $totalProjects = count(glob($path . "/*", GLOB_ONLYDIR));

        $rowTag = "<div class=\"row\">";
        $colTag = "<div class=\"col-sm\">";
        $endDivTag = "</div>"; 
        $cardTag = "
            <div class=\"card\" style=\"width: 18rem;\">
                <img class=\"card-img-top\" src=\"".$imgPath."\" alt=\"Card image cap\">
                <div class=\"card-body\">
                    <h5 class=\"card-title\">".getName($projectPath)."</h5>
                    <p class=\"card-text\">".$desc."</p>
                    <a href=\"".$projectPath."\" class=\"btn btn-primary\">Live Demo</a>
